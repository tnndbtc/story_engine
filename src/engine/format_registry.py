...
# (selector_strategy, prompt_file, item_count) — all 46 formats
FORMAT_REGISTRY: dict[int, tuple[str, str, int]] = {
    # Legacy formats 1–9
    1:  ('mix',         'explainer.txt',    1),    # explainer
    2:  ('mix',         'top5.txt',         5),    # top5
    3:  ('mix',         'radar.txt',        5),    # radar
    4:  ('mix',         'regional.txt',     5),    # regional
    5:  ('mix',         'two_takes.txt',    8),    # two_takes
    6:  ('mix',         'pattern.txt',     12),    # pattern
    7:  ('mix',         'viral.txt',        5),    # viral
    8:  ('mix',         'deep_dive.txt',   15),    # deep_dive
    9:  ('mix',         'niche.txt',        5),    # niche
